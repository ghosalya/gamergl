...
from cube import DEFAULT_EDGES, DEFAULT_VERTICES
...
def main():
    ...
    while game_alive:
        ...
        input_x = 5 * (key_pressed[pygame.K_UP] - key_pressed[pygame.K_DOWN])
        input_y = 5 * (key_pressed[pygame.K_RIGHT] - key_pressed[pygame.K_LEFT])
        input_z = 5 * (key_pressed[pygame.K_a] - key_pressed[pygame.K_d])

        # rotate openGL world by (angle, x, y, z)
        GL.glRotatef(1, input_x, input_y, input_z)
        # clear the world?
        GL.glClear(
